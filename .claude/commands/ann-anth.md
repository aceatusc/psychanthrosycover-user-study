You are performing an **anthropomorphism annotation task** on a counseling conversation.
...
## Step 2 — Apply the anthropomorphism guidelines

@annotation-instructions/anthropomorphism/Guideline.md
...
|---|---|---|
| High anthropomorphism (more human) | `ha` | First-person pronouns, explicit empathy, hedging/softening, warmth/rapport markers, relational continuity |
| Low anthropomorphism (less human) | `la` | Removed self-reference, neutral emotional tone, direct declarative phrasing, no relational markers |
...
- Never add personal stories, claims about feelings/memories/lived experience, or new clinical content.
- Maintain consistent anthropomorphism level across all turns within each version.
...
**`<base>-ha.json`** — high anthropomorphism (more human) version  
**`<base>-la.json`** — low anthropomorphism (less human) version
